# PROOF.md — L1StandardBridge:finalizeBridgeERC20

## Result

The symbolic claim was machine-checked with result `proved`, exit code 0, and no residual against the supplied implementation runtime, SHA-256 `6473973a3992cf61a389793f19d88185d7cbb095e6fecfbdbf6ff683c1d914cd`, under EVM semantics `4f4c3843076c`. This one-claim file extracts the unchanged claim body from the six-operation module that was proved; the extracted file was not separately replayed.
