...
- source: [helpers/StandardBridge.sol:272](helpers/StandardBridge.sol#L272)
...
The target function is [`finalizeBridgeERC20`](helpers/StandardBridge.sol#L272) in the supplied `L1StandardBridge` implementation. The claim executes the implementation runtime in [contract.bin](contract.bin).
